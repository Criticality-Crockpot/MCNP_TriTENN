...
def STA_jockey_contact(f,l,g,hd,flood,vr,d,w,h):
    ...
    if (w == 'yes') and (h == 'yes'):
        ...
        cell_values.append('30 '+ str(hands_mat_num) + ' -1.0 -19 18 12 -15 #5 #6 #7 #10 #11 #12 #15 #16 #17')
        cell_values.append('     #20 #21 #22 imp:n=1   $ hands')
        cell_values.append('31 LIKE 30 BUT #30 TRCL=1')
        cell_values.append('32 LIKE 30 BUT #30 #31 TRCL=2')
        cell_values.append('35 '+ str(hands_mat_num) + ' -1.0 -19 11 -12 imp:n=1   $ hands bottom')
        cell_values.append('36 LIKE 35 BUT #35 TRCL=1')
        cell_values.append('37 LIKE 35 BUT #35 #36 TRCL=2')
        cell_values.append('40 '+ str(hands_mat_num) + ' -1.0 -19 15 -16 imp:n=1    $ hands top')
        cell_values.append('41 LIKE 40 BUT #40 TRCL=1')
        cell_values.append('42 LIKE 40 BUT #40 #41 TRCL=2')
        ...
        if w == 'yes':
            ...
            cell_values.append('6 LIKE 5 BUT TRCL=1')
            cell_values.append('7 LIKE 5 BUT TRCL=2')
            cell_values.append('10 '+str(hands_mat_num)+' -1.0 -16 15 12 -13 #5 #6 #7 imp:n=1 $ hands')
            cell_values.append('11 LIKE 10 BUT #10 TRCL=1')
            cell_values.append('12 LIKE 10 BUT #10 #11 TRCL=2')
            cell_values.append('15 '+str(hands_mat_num)+' -1.0 -16 11 -12 imp:n=1  $ hands bottom')
            cell_values.append('16 LIKE 15 BUT #15 TRCL=1')
            cell_values.append('17 LIKE 15 BUT #15 #16 TRCL=2')
            cell_values.append('20 '+str(hands_mat_num)+' -1.0 -16 13 -14 imp:n=1  $ hands top')
            cell_values.append('21 LIKE 20 BUT #20 TRCL=1')
            cell_values.append('22 LIKE 20 BUT #20 #21 TRCL=2')
            cell_values.append('50 200 -7.82 1 -5 6 -9 10 -11 imp:n=1  $ rail')
            if flood == 'yes_liquid':
                cell_values.append('100 300 -1.0 -20 #5 #6 #7 #10 #11 #12')
            elif flood== 'yes_steam':
